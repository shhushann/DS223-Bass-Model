...
- `img/bass_model_gmv.png`: Bass model fit for ThredUp GMV (Gross Merchandise Value) forecast.  
- `img/bass_model_rev.png`: Bass model fit for ThredUp Revenue forecast.  
